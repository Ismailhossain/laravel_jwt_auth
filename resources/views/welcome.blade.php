    ...
    <div class="container">
        <div class="form">
            ...
            <form class="register-box" method="post" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input class="form-control" type="password" placeholder="password_confirmation" name="password_confirmation" required>
                </div>
                <button type="submit" class="btn btn-lg btn-primary btn-block btn-signup">Register</button>
